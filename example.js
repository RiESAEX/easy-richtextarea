    ...
    var Selection1 = /* @__PURE__ */ function() {
      ...
      _createClass(Selection12, [
      ...
      ], [
        {
          key: "fromNothing",
          value: function fromNothing() {
            var startPosition = 0, endPosition = 0, selection = new Selection12(startPosition, endPosition);
            return selection;
          }
        },
        {
          ...
          value: function fromDOMElement(domElement) {
            var selectionStart = domElement.selectionStart, selectionEnd = domElement.selectionEnd, startPosition = selectionStart, endPosition = selectionEnd, selection = new Selection12(startPosition, endPosition);
            return selection;
          }
        },
        {
          ...
          value: function fromStartPositionAndEndPosition(startPosition, endPosition) {
            var selection = new Selection12(startPosition, endPosition);
            return selection;
          }
        }
      ]);
